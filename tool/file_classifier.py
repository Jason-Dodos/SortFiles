...
def classify_files(source_dirs, target_base_dir):
    """对指定目录中的文件进行分类"""
    # 确保目标基础目录存在
...
if __name__ == "__main__":
    # 定义要处理的源目录
    source_directories = [
        r'E:\recvr\recup_dir.1',
        r'E:\recvr\recup_dir.2',
        r'E:\recvr\recup_dir.3'
    ]
    ...
    # 执行分类
    classify_files(source_directories, target_directory)